  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_ROWRECIPE: {
          if ("layout/row_recipe_0".equals(tag)) {
            return new RowRecipeBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for row_recipe is invalid. Received: " + tag);
        }
      }
    }
    return null;
